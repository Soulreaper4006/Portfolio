...
@section('title', $project['title'] . ' - ' . __('messages.my_projects'))

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <a href="{{ route('projects') }}" class="text-purple-400 hover:text-purple-300 transition flex items-center">
            &larr; <span class="ml-2">{{ __('messages.back_to_projects') }}</span>
        </a>
    </div>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="md:w-1/3 shrink-0">
                    <div class="bg-gray-900/50 p-6 rounded-xl border border-gray-700 sticky top-24">
                        <h3 class="text-white font-bold text-lg mb-4">{{ __('messages.project_links') }}</h3>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-700">
                             <p class="text-sm text-gray-500 text-center">{{ __('messages.share_project') }}</p>
